...
class OnboardingViewController: UIViewController {
    ...
    func onboardingItem(at index: Int) -> OnboardingItemInfo {
      ...
      return [
        OnboardingItemInfo(informationImage: UIImage(named: "onboard1")!,
                           title: "1. 決める",
                           description: "どんな人にプレゼントを贈りますか？",
                           pageIcon: UIImage(named: "onboard1")!,
                           color: UIColor.white,
        ...
        OnboardingItemInfo(informationImage: UIImage(named: "onboard2")!,
                           title: "2. つくる",
                           description: "決めたら、その人専用のポストを作る。\nいろいろ管理しましょう。",
                           pageIcon: UIImage(named: "onboard2")!,
                           color: UIColor.white,
                           titleColor: UIColor.black,
                           descriptionColor: UIColor.systemGray,
                           titleFont: UIFont.systemFont(ofSize: 40.0),
        ...
        OnboardingItemInfo(informationImage: UIImage(named: "onboard3")!,
                           title: "3. 貯める",
                           description: "その人のためにお金を貯めてみる。\n貯金のための機能があります。",
                           pageIcon: UIImage(named: "onboard3")!,
                           color: UIColor.white,
                           titleColor: UIColor.black,
                           descriptionColor: UIColor.systemGray,
                           titleFont: UIFont.systemFont(ofSize: 40.0),
        ...
        OnboardingItemInfo(informationImage: UIImage(named: "onboard4")!,
                           title: "4. 贈る",
                           description: "自分の気持ちを大事な人に贈ってみる。\nきっと、喜んでくれる。",
                           pageIcon: UIImage(named: "onboard4")!,
                           color: UIColor.white,
                           titleColor: UIColor.black,
                           descriptionColor: UIColor.systemGray,
                           titleFont: UIFont.systemFont(ofSize: 40.0),
